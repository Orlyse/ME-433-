...
static const uint8_t OV7670_init[92][2] = {
    ...
    {OV7670_REG_BRIGHT, 0x98},  // originally 00 other options: 
    {OV7670_REG_CONTRAS, 0x48}, // originally 40 other options: 50
    {OV7670_REG_CONTRAS_CENTER, 0x80}, // 0x40? originally: 80
    {0xff, 0xff},
